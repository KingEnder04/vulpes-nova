...
public class SnowyNightmareMobVN extends HostileMob {
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 24 * 64, new GameDamage(50), 5, 40000));
    }
