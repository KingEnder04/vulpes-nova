...
public class NightmareCubeMobVN extends HostileMob {
...
// should be 50 damage
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 3000, new GameDamage(30), 5, 40000));
    }
