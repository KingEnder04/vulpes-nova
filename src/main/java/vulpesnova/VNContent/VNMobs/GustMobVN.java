...
public class GustMobVN extends FlyingHostileMob {
    ...
    public void init() {
        super.init();
        // Setup AI
        ai = new BehaviourTreeAI<>(this, new CollisionPlayerChaserWandererAI<>(null, 456, new GameDamage(14), 5, 40000), new FlyingAIMover());
    }
