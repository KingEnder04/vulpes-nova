...
public class MinersHavenCaveLevelVN extends MinersHavenSurfaceLevelVN {
    public MinersHavenCaveLevelVN(LevelIdentifier identifier, int width, int height, WorldEntity worldEntity) {
    ...
    public void generateLevel() {
        ...
        GameEvents.triggerEvent(new GenerateCaveMiniBiomesEvent(this, cg), (e) -> {
            ...
            GenerationTools.generateRandomSmoothTileVeins(this, cg.random, 0.02F, 2, 2.0F, 10.0F, 2.0F, 8.0F, TileRegistry.getTileID("lavatile"), 1.0F, true);
        ...
        GameEvents.triggerEvent(new GenerateCaveOresEvent(this, cg), (e) -> {
            ...
            cg.generateOreVeins(0.3F, 5, 15, ObjectRegistry.getObjectID("copperorerock"));
            cg.generateOreVeins(0.3F, 5, 15, ObjectRegistry.getObjectID("ironorerock"));
            cg.generateOreVeins(0.3F, 5, 15, ObjectRegistry.getObjectID("goldorerock"));
            cg.generateOreVeins(0.2F, 5, 15, ObjectRegistry.getObjectID("quartzrock"));
            cg.generateOreVeins(0.2F, 5, 15, ObjectRegistry.getObjectID("frostshardrock"));
            cg.generateOreVeins(0.2F, 5, 15, ObjectRegistry.getObjectID("ivyorerock"));
        });
        ...
        GenerationTools.generateRandomSmoothVeinsL(this, cg.random, 0.05F, 4, 4.0F, 7.0F, 4.0F, 8.0F, (lg) -> {
            ...
            ca.streamAliveOrdered().forEachOrdered((tile) -> {
                ...
                if (cg.random.getChance(0.3F) && amethystCrystalClusterSmall.canPlace(this, tile.x, tile.y, 0, false) == null) {
                    amethystCrystalClusterSmall.placeObject(this, tile.x, tile.y, 0, false);
                }
        ...
        GenerationTools.generateRandomSmoothVeinsL(this, cg.random, 0.05F, 4, 4.0F, 7.0F, 4.0F, 8.0F, (lg) -> {
            ...
            ca.streamAliveOrdered().forEachOrdered((tile) -> {
                ...
                if (cg.random.getChance(0.3F) && sapphireCrystalClusterSmall.canPlace(this, tile.x, tile.y, 0, false) == null) {
                    sapphireCrystalClusterSmall.placeObject(this, tile.x, tile.y, 0, false);
                }
        ...
        GameEvents.triggerEvent(new GenerateCaveStructuresEvent(this, cg, presets), (e) -> {
            ...
            for(int ix = 0; ix < caveRuinsCount; ++ix) {
                WallSet wallSet = (WallSet)cg.random.getOneOf(new WallSet[]{WallSet.stone, WallSet.wood});
                FurnitureSet furnitureSet = (FurnitureSet)cg.random.getOneOf(new FurnitureSet[]{FurnitureSet.oak, FurnitureSet.spruce});
                String floorStringID = (String)cg.random.getOneOf(new String[]{"woodfloor", "woodfloor", "stonefloor", "stonebrickfloor"});
